...
export const PROJECTS = [
  {
    ...
    specs: [{ key: 'LOC', value: '6.3k' }, { key: 'Year', value: '2026' }],
  },
  {
  ...
  { year: '2026', org: 'Swiss Armed Forces', loc: 'Bern', mode: 'On-site', now: true,
    roles: [
      { role: 'Sergeant', period: 'Jun 2026 – Now',
        ...
        tags: ['Leadership', 'Signals Intel', 'Training', 'Organisation'] },
      { role: 'NCO School', period: 'May 2026 – Jun 2026',
        blurb: 'Advanced non-commissioned officer training in leadership and small-unit command, including promotion to Sergeant (OR-5). I also qualified as a shooting instructor (Schiessleiter).',
        tags: ['Command', 'Leadership', 'Shooting', 'Teamwork', 'Self-awareness'] },
      { role: 'Strategic Radio Reconnaissance', period: 'Feb 2026 – May 2026',
        ...
        tags: ['Signals Intel', 'Recon', 'Jamming', 'OSINT'] },
      { role: 'Radio Relay & Switchboard Operator', period: 'Jan 2026 – Feb 2026',
        blurb: 'Recruit (OR-1). This was my basic training (Grundausbildung), combining the general military foundations with tactical communications: directional line-of-sight radio links and communications relay / switchboard operation.',
        tags: ['Tactical Comms', 'Radio', 'Radio Tank', 'Shooting', 'Teamwork', 'Fieldcraft'] },
    ] },
  { year: '2021', end: '2026', org: 'IMS Software', loc: 'Bern', mode: 'Hybrid',
    roles: [
      { role: 'Fullstack Software Engineer', period: 'Aug 2025 – Jan 2026',
        blurb: 'After finishing my apprenticeship, I continued at IMS, working in an agile Scrum team and building business web applications with Java / Quarkus on the backend and Angular on the frontend. I focused mainly on the asaGate / asaWheels app for the cantonal road traffic offices, and on the GVB apps, which we rewrote. Alongside the engineering, I supported and helped mentor the apprentices while earning my Berufsbildner certificate.',
        tags: ['Java', 'Quarkus', 'Angular', 'Scrum', 'DevOps', 'Kubernetes'],
        links: {
          'asaGate / asaWheels': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/asagate-asawheels',
          'GVB apps': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/gvb',
        } },
      { role: 'Apprenticeship, Software Engineer EFZ', period: 'Aug 2021 – Jul 2025',
        blurb: 'I completed a four-year federal IT apprenticeship (EFZ). I spent the first year, along with all inter-company courses (üK), at Berufsbildungscenter, where I learned the fundamentals from operating systems and telematics to full-stack and mobile development.\n\nFrom the second year on, I worked in a productive Scrum team at IMS, where I maintained and extended the GVB Sales and GVB Evaluate PWAs and integrated SAP and Power BI APIs. On the CUT project, I helped build secure software for heavy workloads and shipped apps like EPS and PVS across the full DevOps cycle, from planning and prototyping through development, testing, deployment, and maintenance. In my final year, I was the main developer on the asaGate / asaWheels app and knew it inside out, and I built my practical final project (IPA) on PVS, which earned a 5.7. I finished the apprenticeship with an overall grade of 5.7 (out of 6), and I am grateful to IMS for an outstanding training experience.',
        tags: ['Java', 'Angular', 'Scrum', 'DevOps', 'Kubernetes', 'a lot more'],
        links: {
          'Berufsbildungscenter': 'https://berufsbildungscenter.ch',
          'GVB Sales': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/gvb_salesapp',
          'GVB Evaluate': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/gvb',
          'CUT': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/cut',
          'EPS': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/cut-eps',
          'PVS': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/pvs',
          'asaGate / asaWheels': 'https://www.ims.ch/de/erfolgsgeschichten/projekte/asagate-asawheels',
        } },
    ] },
];
